    ...
    <div className="PricesPage"> 
      ...
      <br/>
        <div className="cont">
            ...
            <div className="contents">
              <h2 style={{fontFamily: "Garamond"}}>
                <span style={{fontSize: "35px"}}>1500 за 4 занятия</span> <br/>
                <br/>
                <div style={{fontSize: "20px"}}>Этот абонемент рассчитан на четыре занятия по одному из направлений, не включая персональные тренировки. 
        ...
        <div className="cont2">
           ...
           <img src={card2} className="imgBoxes2" alt="" /> 
            ...
            <h2 style={{fontFamily: "Garamond"}}>
                ...
                <br/>
                <div style={{fontSize: "20px"}}>Этот абонемент рассчитан на восемь занятий, правила посещения идентичны абонементу на четыре занятия. 
        ...
        <div className="cont">
            ...
            <div className="contents">
            <h2 style={{fontFamily: "Garamond"}}>
                <span style={{fontSize: "35px"}}>3000 за 12 занятий </span> <br/>
                <br/>
                <div style={{fontSize: "20px"}}>Этот абонемент рассчитан на двенадцать занятий, правила посещения идентичны абонементу на четыре и 
        ...
        <div className="cont2">
            ...
            <h2 style={{fontFamily: "Garamond"}}>
                ...
                <br/>
                <div style={{fontSize: "20px"}}>Этот абонемент предназначен для людей, которые хотят посещать персональные тренировки с тренером два
        ...
        <div className="cont2">
            ...
            <h2 style={{fontFamily: "Garamond"}}>
                ...
                <br/>
                <div style={{fontSize: "20px"}}>Этот абонемент идентичен абонементу на восемь индивидуальных занятий, только рассчитан он на три 
        ...
        <div className="cont2">
            ...
            <h2 style={{fontFamily: "Garamond"}}>
                ...
                <br/>
                <div style={{fontSize: "20px"}}>Это самый удобный абонемент, позволяющий посещать любые занятия (не считая персональные тренировки) 
